...
namespace
{
    ...
    glm::vec3 coloredLightColor(0.07f, 0.85f, 0.28f); //teal
...
void URender()
{
    ...
    for (unsigned int i = 0; i < numElements; i++) {
        ...
        viewLoc = glGetUniformLocation(gLampProgramId, "view");
        projLoc = glGetUniformLocation(gLampProgramId, "projection");
        objectColorLoc = glGetUniformLocation(gLampProgramId, "uObjectColor");
        ...
        if (i != 4) {
            glProgramUniform4f(gLampProgramId, objectColorLoc, pointLightColor.r, pointLightColor.g, pointLightColor.b, 1.0f);
        }
        else {
            glProgramUniform4f(gLampProgramId, objectColorLoc, coloredLightColor.r, coloredLightColor.g, coloredLightColor.b, 1.0f);
        }
...
void CreateLights()
{
    ...
    glUniform3f(glGetUniformLocation(gCubeProgramId, "dirLight.direction"), ambientLightPos.x, ambientLightPos.y, ambientLightPos.z);
    glUniform3f(glGetUniformLocation(gCubeProgramId, "dirLight.ambient"), ambientLightColor.r, ambientLightColor.g, ambientLightColor.b);
    glUniform3f(glGetUniformLocation(gCubeProgramId, "dirLight.diffuse"), ambientLightColor.r, ambientLightColor.g, ambientLightColor.b);
    glUniform3f(glGetUniformLocation(gCubeProgramId, "dirLight.specular"), ambientLightColor.r, ambientLightColor.g, ambientLightColor.b);
    ...
    for (unsigned int i = 0; i < numElements; i++) {
        ...
        glUniform3f(GetUniformLocation(gCubeProgramId, "pointLights[" + std::to_string(i) + "].position"), pointLightPositions[i].x, pointLightPositions[i].y, pointLightPositions[i].z);

        //make the 5th light in the array colored
        if (i != 4) {
            glUniform3f(GetUniformLocation(gCubeProgramId, "pointLights[" + std::to_string(i) + "].ambient"), pointLightColor.r, pointLightColor.g, pointLightColor.b);
            glUniform3f(GetUniformLocation(gCubeProgramId, "pointLights[" + std::to_string(i) + "].diffuse"), pointLightColor.r, pointLightColor.g, pointLightColor.b);
            glUniform3f(GetUniformLocation(gCubeProgramId, "pointLights[" + std::to_string(i) + "].specular"), pointLightColor.r, pointLightColor.g, ambientLightColor.b);

            //set the attenuation components to ~20 units
            //from: https://wiki.ogre3d.org/tiki-index.php?page=-Point+Light+Attenuation
            glUniform1f(GetUniformLocation(gCubeProgramId, "pointLights[" + std::to_string(i) + "].constant"), 1.0f);
            glUniform1f(GetUniformLocation(gCubeProgramId, "pointLights[" + std::to_string(i) + "].linear"), 0.22f);
            glUniform1f(GetUniformLocation(gCubeProgramId, "pointLights[" + std::to_string(i) + "].quadratic"), 0.20f);
        }
        else {
            glUniform3f(GetUniformLocation(gCubeProgramId, "pointLights[" + std::to_string(i) + "].ambient"), coloredLightColor.r, coloredLightColor.g, coloredLightColor.b);
            glUniform3f(GetUniformLocation(gCubeProgramId, "pointLights[" + std::to_string(i) + "].diffuse"), coloredLightColor.r, coloredLightColor.g, coloredLightColor.b);
            glUniform3f(GetUniformLocation(gCubeProgramId, "pointLights[" + std::to_string(i) + "].specular"), coloredLightColor.r, coloredLightColor.g, coloredLightColor.b);

            //set the attenuation components to ~50 units to make the color cast stronger
            //from: https://wiki.ogre3d.org/tiki-index.php?page=-Point+Light+Attenuation
            glUniform1f(GetUniformLocation(gCubeProgramId, "pointLights[" + std::to_string(i) + "].constant"), 1.0f);
            glUniform1f(GetUniformLocation(gCubeProgramId, "pointLights[" + std::to_string(i) + "].linear"), 0.09f);
            glUniform1f(GetUniformLocation(gCubeProgramId, "pointLights[" + std::to_string(i) + "].quadratic"), 0.032f);
        }
