...
//June 5, 2023
//
//Module 6: 3D Scene with Camera and Texture and Lighting
...
int main(int argc, char* argv[])
{
    ...
    #define TEXPATH "../CS-330 Module 6 with Lighting/Textures/"

    // Load texture 0
    texFilename =  TEXPATH "placemat.jpg";
    ...
    // Load texture 1
    texFilename = TEXPATH "orange_peel_ss.jpg";
    ...
    // Load texture 2
    texFilename = TEXPATH "orange_paper_ss.jpg";
    ...
    // Load texture 3
    texFilename = TEXPATH "wood_grain.jpg";
    ...
    // Load texture 4
    texFilename = TEXPATH "black_plastic2_ss.jpg";
...
void URender()
{
    ...
    glProgramUniform4f(surfaceProgramId, objectColorLoc, 1.0f, 0.0f, 0.0f, 1.0f);

    //light 1
    gLightPosition = pointLightPositions[0];
    GLint keyColorLoc = glGetUniformLocation(surfaceProgramId, "keyColor");
    GLint keyPositionLoc = glGetUniformLocation(surfaceProgramId, "keyPos");
    ...
    GLint lightColorLoc = glGetUniformLocation(surfaceProgramId, "lightColor");
    GLint lightPositionLoc = glGetUniformLocation(surfaceProgramId, "lightPos");
    ...
    glProgramUniform4f(surfaceProgramId, objectColorLoc, 0.5f, 0.0f, 0.5f, 1.0f);

    //light 1
    gLightPosition = pointLightPositions[0];
    keyColorLoc = glGetUniformLocation(surfaceProgramId, "keyColor");
    keyPositionLoc = glGetUniformLocation(surfaceProgramId, "keyPos");
    ...
    //light 2
    gLightPosition = pointLightPositions[1];
    lightColorLoc = glGetUniformLocation(surfaceProgramId, "lightColor");
    lightPositionLoc = glGetUniformLocation(surfaceProgramId, "lightPos");
    ...
    glProgramUniform4f(surfaceProgramId, objectColorLoc, 0.0f, 0.5f, 0.15f, 1.0f);
    ...
    // 1. Scales the object
    scale = glm::scale(glm::vec3(0.401f, 0.5f, 0.401f));
    // 2. Rotate the object
    ...
    glProgramUniform4f(surfaceProgramId, objectColorLoc, 0.97f, 0.48f, 0.04f, 1.0f);
    ...
    glProgramUniform4f(surfaceProgramId, objectColorLoc, 1.0f, 1.0f, 0.0f, 1.0f);
